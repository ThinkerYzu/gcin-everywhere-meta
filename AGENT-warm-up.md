...
Key codebase location: `sources/gcin-everywhere/` (relative to claudebugzilla root). gcin upstream is at `sources/gcin-everywhere/gcin/` (submodule). New IBus engine code goes in `sources/gcin-everywhere/ibus-engine/`.
